package com.incava.ex63locationmanger;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //디바이스에서 제공하느 프로바이더의 종류들을 먼저 확인해보기
        ...
        // 위치정보제공에 대한 동적퍼미션
        int checkPermission = checkSelfPermission(android.Manifest.permission.ACCESS_FINE_LOCATION);
